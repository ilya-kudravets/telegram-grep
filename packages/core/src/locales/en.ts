...
export const en = {
  ...
  tplKeyFormats: 'leaked keys by format (GitHub, AWS, bot tokens…)',
  tplSeed: 'seed phrases & private keys',
  tplCards: 'card numbers',
  tplBank: 'bank details (IBAN, account numbers)',
  tplCrypto: 'crypto addresses',
  tplDocs: 'ID documents',
  tplEmails: 'emails',
  tplPhones: 'phone numbers',
  tplAddress: 'postal address',
  tplLocation: 'locations & coordinates',
  tplInvites: 'invite links',
  tplInfra: 'servers: IPs & ssh',
