...
export const en = {
  ...
  codeResendIn: 'If it does not arrive, Telegram will send another via {0} in {1}s.',
  codeNoResend: 'Telegram offers no second delivery for this attempt.',
  codeFlood:
    'Telegram is rate-limiting code requests for this number — wait {0}s before trying again.',
  phoneFlood:
    'Too many login attempts for this number: Telegram has stopped sending codes for a while (hours, not minutes). This is its anti-abuse limit, not a failure of this app.',
  ...
  tplCards: 'card numbers',
  tplEmails: 'emails',
  tplPhones: 'phone numbers',
  tplCrypto: 'crypto addresses',
  tplDocs: 'document numbers',
  tplAddress: 'postal address',
  patternsFromFile: 'from patterns.txt',
